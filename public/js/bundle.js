...
var displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1Ijoiamp1MWk0biIsImEiOiJjbDY4N2I4eHczc2VoM2lvMXMyODJ6MXU2In0.g20TcwXVDP5CO2atzHXpXQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/jju1i4n/cl687nmyo005s14m8n62rmuh0',
    scrollZoom: false //center: [-40, 34],
    //zoom: 10,
    //interactive: false
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            apiUrl = '/api/v1/users/';
            endUrl = type === 'password' ? 'updateMyPassword' : 'updateMe';
            _context.next = 5;
            return _axios.default.patch(apiUrl + endUrl, data);
...
},{"./alerts.js":"alerts.js","axios":"../../node_modules/axios/index.js"}],"login.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Account created successfully! Redirecting...');
              window.setTimeout(function () {
                location.assign('/');
              }, 1200);
            }
...
var stripe = Stripe('pk_test_51LRkjVLARGILMDL8vLcxkO7xVx0eNhsMfMxZ3wJGE5BAyJp7MVxg1vSPdDzzZC6aGRkZjwgH9amNYZGMpmldtmZC00EzHJ3AYQ');
...
if (updateUserDataForm) updateUserDataForm.addEventListener('submit', function (event) {
  event.preventDefault();
  ...
  (0, _updateSettings.updateSettings)('data', form); //our axios will recognize the form as an object and it will work just the same
});
if (updateUserPasswordForm) updateUserPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    var passwordOld, password, passwordConfirm;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            passwordOld = document.getElementById('password-current').value;
